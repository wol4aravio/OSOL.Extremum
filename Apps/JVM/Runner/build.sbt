...
libraryDependencies += "com.github.wol4aravio" %% "OSOL.Extremum.Algorithms.Scala.RandomSearch" % "0.0.5.1-SNAPSHOT"
libraryDependencies += "com.github.wol4aravio" %% "OSOL.Extremum.Algorithms.Scala.ExplosionSearch" % "0.0.5.1-SNAPSHOT"
