...
namespace OSOL.Extremum.Cores.DotNet.Optimization.Testing
{
    public class RealTester: Tester<RealVector, double, RealVector>
    {
        ...
        public RealTester()
        {
            ...
            RemoteFunction<double> f1 = new RealRemoteFunction(json: $"{TASKS_LOC}/Dummy/Dummy_1.json", port: 10010, field: "f");
            ...
            RemoteFunction<double> f2 = new RealRemoteFunction(json: $"{TASKS_LOC}/Dummy/Dummy_2.json", port: 10010, field: "f");
            ...
            RemoteFunction<double> f3 = new RealRemoteFunction(json: $"{TASKS_LOC}/Dummy/Dummy_3.json", port: 10010, field: "f");
