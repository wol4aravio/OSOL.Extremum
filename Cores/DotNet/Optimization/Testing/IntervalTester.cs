...
namespace OSOL.Extremum.Cores.DotNet.Optimization.Testing
{
    public class IntervalTester: Tester<IntervalVector, Interval, IntervalVector>
    {
        ...
        public IntervalTester()
        {
            ...
            RemoteFunction<Interval> f1 = new IntervalRemoteFunction(json: $"{TASKS_LOC}/Dummy/Dummy_1.json", port: 5021, field: "f");
            ...
            RemoteFunction<Interval> f2 = new IntervalRemoteFunction(json: $"{TASKS_LOC}/Dummy/Dummy_2.json", port: 5022, field: "f");
            ...
            RemoteFunction<Interval> f3 = new IntervalRemoteFunction(json: $"{TASKS_LOC}/Dummy/Dummy_3.json", port: 5023, field: "f");
