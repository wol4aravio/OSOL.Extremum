...
namespace OSOL.Extremum.Cores.DotNet.CodeFeatures.FunctionParser
{
    public static class Parser
    {
        ...
        private static FileStream ExtractResource(string filename, string suffix, string location = "", string where = ".")
        {
            ...
            string resourceName = $"OSOL.Extremum.Cores.DotNet.Resources.{filename}.{suffix}";
            if(location.Length != 0)
            {
                resourceName = $"OSOL.Extremum.Cores.DotNet.Resources.{location}.{filename}.{suffix}";
            }
