...
namespace OSOL.Extremum.Cores.DotNet.Vectors
{
    public abstract class VectorObject<TBase>
    {
        ...
        public static Dictionary<string, TBase> operator *(VectorObject<TBase> a, double coefficient) =>
        ...
        public static Dictionary<string, TBase> operator -(VectorObject<TBase> a, VectorObject<TBase> b) =>
            a.Subtract(b);
        ...
        public Dictionary<string, TBase> Union(params Tuple<string, TBase>[] vectors)
        {
            var allKeys = new List<string>();
            allKeys.AddRange(this.Keys);
            allKeys.AddRange(vectors.Select(_ => _.Item1));
            allKeys = allKeys.Distinct().ToList();
            return allKeys.ToDictionary(k => k, k =>
            {
