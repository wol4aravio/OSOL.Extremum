...
class Interval private (val lowerBound: Double, val upperBound: Double) {
  ...
  /** Same as [[OSOL.Extremum.Cores.JVM.Arithmetics#equalsTo equalsTo]] */
  ...
  /** Same as [[OSOL.Extremum.Cores.JVM.Arithmetics#approximatelyEqualsTo approximatelyEqualsTo]] */
  ...
  /** Same as [[OSOL.Extremum.Cores.JVM.Arithmetics#neg neg]] */
  ...
  /** Same as [[OSOL.Extremum.Cores.JVM.Arithmetics#add add]] */
  ...
  /** Same as [[OSOL.Extremum.Cores.JVM.Arithmetics#sub sub]] */
  ...
  /** Same as [[OSOL.Extremum.Cores.JVM.Arithmetics#mul mul]] */
  ...
  /** Same as [[OSOL.Extremum.Cores.JVM.Arithmetics#div div]] */
  ...
  /** Same as [[OSOL.Extremum.Cores.JVM.Arithmetics#pow pow]] */
...
/** Companion object for [[OSOL.Extremum.Cores.JVM.Arithmetics.Interval Interval]] */
object Interval {
  ...
  /** Implicit converters for [[OSOL.Extremum.Cores.JVM.Arithmetics.Interval Interval]] */
  object Converters {
  ...
  /** Exceptions that can be raised for [[OSOL.Extremum.Cores.JVM.Arithmetics.Interval Interval]] */
  object Exceptions {
