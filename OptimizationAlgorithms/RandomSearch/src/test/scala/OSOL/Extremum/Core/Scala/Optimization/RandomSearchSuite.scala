...
class RandomSearchSuite extends FunSuite {
  ...
  test("Test # 1") {
    ...
    val tool: Algorithm[RealVector, Double, RealVector] = RandomSearch.createFixedStepRandomSearch(radius = r, maxTime = a1.size * fiveSec)
  ...
  test("Test # 2") {
    ...
    val tool: Algorithm[RealVector, Double, RealVector] = RandomSearch.createFixedStepRandomSearch(radius = r, maxTime = a2.size * fiveSec)
  ...
  test("Test # 3") {
    ...
    val tool: Algorithm[RealVector, Double, RealVector] = RandomSearch.createFixedStepRandomSearch(radius = r, maxTime = a3.size * fiveSec)
